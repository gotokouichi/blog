                  ...
                  <div class="flex-auto p-5 lg:p-10">
                    ...
                    bg-gray-300 placeholder-black text-gray-800 outline-none focus:bg-gray-400" placeholder=" " style="transition: all 0.15s ease 0s;" required />
                      ...
                      <div class="relative w-full mb-3">
                        ...
                        <textarea maxlength="300" name="contents" id="content" rows="4" cols="80" class="border-0 px-3 py-3 bg-gray-300 placeholder-black text-gray-800 rounded text-sm shadow focus:outline-none w-full" placeholder="" required><?php print($blogInfomation['contents']); ?></textarea>
                      </div>
