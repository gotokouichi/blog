      ...
      <?php foreach ($posts as $post) : ?>
        <div class="blogs bg-white w-1/5 m-8">
          ...
          <div class="p-5">
            ...
            <p class="bg-white text-sm text-black"><?php echo mb_strimwidth(strip_tags($post['contents']), 0, 15, '…', 'UTF-8') ?></p>
            <a href="./post/detail.php?id=<?php echo $post['id'] ?>" class="py-2 px-3 mt-4 px-6 text-white bg-green-500 inline-block rounded">記事詳細へ</a>
          </div>
        </div>
      <?php endforeach; ?>
    </div>
